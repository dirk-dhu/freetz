$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,1.0.2u))
...
$(PKG)_SOURCE_SHA256_1.0.2u  := ecd0c6ffb493dd06707d38b14bb4d8c2288bb7033735606569d8f90f89669d16
$(PKG)_SOURCE_SHA256         := $($(PKG)_SOURCE_SHA256_$($(PKG)_VERSION))
$(PKG)_SITE_SUFFIX_0.9.8zh   := /old/0.9.x
$(PKG)_SITE_SUFFIX_1.0.2u    := /old/1.0.2
$(PKG)_SITE                  := http://www.openssl.org/source$($(PKG)_SITE_SUFFIX_$($(PKG)_VERSION))
